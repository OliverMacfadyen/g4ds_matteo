...
DSDetectorDS50::DSDetectorDS50(G4VPhysicalVolume* myMotherVolume) {
  ...
  bool IsRealisticFieldRings = DSStorage::Get()->GetIsCopperRings();
  ...
  // fLogicTrunkAr->SetVisAttributes(G4VisAttributes::GetInvisible());
  // fLogicTrunk->SetVisAttributes(G4VisAttributes::GetInvisible());

  // --------------------------- //
  // ------   Cryostats   ------ //
  // --------------------------- //

  // Load cryostat profiles                   // NOTE:  Each cryostat profile is
  // evaluated in the ref frame with z = 0 at the level of the internal cryostat
  // ear
  ...
  fPhysicDS50 = new G4PVPlacement(0, myZeros, "OuterCryostat", fLogicDS50, fMotherVolume, false, 0,
                                  myCheckOverlap);  //  No translations applied as the shift in z
  // fLogicDS50->SetVisAttributes(G4VisAttributes::GetInvisible()); //  is
  // accounted for when profiles are loaded

  // Vacuum Region
  // fSolidVacuumCryostat_0 = new G4Polycone( "VacuumCryostat0_Solid", 0,
  // myTwoPi, myNumPointsVacCryo, myVacuumCryostatRout, myVacuumCryostatZ );
  ...
  // fLogicVacuumCryostat->SetVisAttributes(G4VisAttributes::GetInvisible());
  ...
  // fLogicInnerCryostat->SetVisAttributes(G4VisAttributes::GetInvisible());
  ...
  // fLogicGasArgon->SetVisAttributes(G4VisAttributes::GetInvisible());
  ...
  //   fLogicOuterLiqArgon  = new G4LogicalVolume( fSolidOuterLiqArgon,
  //   DSMaterial::Get()->GetLiquidArgon(), "OuterLiquidArgon_Logic" );
  // else
  ...
  // fLogicOuterLiqArgon->SetVisAttributes(G4VisAttributes::GetInvisible());
  ...
  fLogicInnerLiqArgon = new G4LogicalVolume(fSolidInnerLiqArgon, DSMaterial::Get()->GetNSLiquidArgon(), "InnerLiqArgon_Logic");
  ...
  // fLogicInnerLiqArgon->SetVisAttributes(G4VisAttributes::GetInvisible());
  ...
  fLogicInnerLiqArgonBetween = new G4LogicalVolume(fSolidInnerLiqArgonBetween, DSMaterial::Get()->GetNSLiquidArgon(), "InnerLiqArgonBetween_Logic");
  ...
  // fLogicInnerLiqArgonBetween->SetVisAttributes(G4VisAttributes::GetInvisible());
  fLogicTeflonSupport->SetVisAttributes(new G4VisAttributes(G4Colour(1.0, 1.0, 1.0)));
  ...
  fLogicPMTAssemblyTop = new G4LogicalVolume(fSolidPMTAssembly, DSMaterial::Get()->GetNSLiquidArgon(), "PMTAssemblyTop_Logic");
  ...
  fLogicPMTAssemblyBottom = new G4LogicalVolume(fSolidPMTAssembly, DSMaterial::Get()->GetNSLiquidArgon(), "PMTAssemblyBottom_Logic");
  ...
  // PMTs
  // --- Note: fPhysicInnerLiqArgon is passed as argument just for the
  // definition of the surface between the photocathode and the LAr
  ...
  // G4ThreeVector myCathodeWinPos( 0, 0, - myTeflonSupport_h/2. +
  // myLArBottomLayerThickness + myITOThickness + myCathodeWindow_h/2. );
  ...
  fLogicCathodeWindow->SetVisAttributes(new G4VisAttributes(G4Colour(1.0, 0.0, .40)));
  ...
  // fPhysicCathodeITOBottom = new G4PVPlacement( 0, myITOBottomPos,
  // "CathodeWindowITOBottom", fLogicITO, fPhysicInnerLiqArgon, false, 0,
  // myCheckOverlap ); fPhysicCathodeITOTop    = new G4PVPlacement( 0,
  // myITOTopPos,    "CathodeWindowITOTop",    fLogicITO, fPhysicInnerLiqArgon,
  ...
  // G4ThreeVector myReflectorPos = myCathodeWinPos + G4ThreeVector( 0, 0,
  // 2*myITOThickness + myCathodeWindow_h/2.);
  ...
  G4int myNZR = 0;
  myReflectorProf_Z[myNZR] = 0;
  myReflectorProf_R[myNZR++] = 0;
  myReflectorProf_Z[myNZR] = 0;
  myReflectorProf_R[myNZR++] = myReflector_od / 2.;
  myReflectorProf_Z[myNZR] = myReflector_h;
  myReflectorProf_R[myNZR++] = myReflector_od / 2.;
  myReflectorProf_Z[myNZR] = myReflector_h;
  myReflectorProf_R[myNZR++] = myAboveGrid_od / 2.;
  myReflectorProf_Z[myNZR] = myReflector_h + myAboveGrid_h;
  myReflectorProf_R[myNZR++] = myAboveGrid_od / 2.;
  myReflectorProf_Z[myNZR] = myReflector_h + myAboveGrid_h;
  myReflectorProf_R[myNZR++] = 0;

  G4int myNZR_TPB = 0;
  myReflectorTPBProf_Z[myNZR_TPB] = 0;
  myReflectorTPBProf_R[myNZR_TPB++] = 0;
  myReflectorTPBProf_Z[myNZR_TPB] = 0;
  myReflectorTPBProf_R[myNZR_TPB++] = myReflector_id / 2.;
  myReflectorTPBProf_Z[myNZR_TPB] = myReflector_h;
  myReflectorTPBProf_R[myNZR_TPB++] = myReflector_id / 2.;
  myReflectorTPBProf_Z[myNZR_TPB] = myReflector_h;
  myReflectorTPBProf_R[myNZR_TPB++] = myAboveGrid_id / 2.;
  myReflectorTPBProf_Z[myNZR_TPB] = myReflector_h + myAboveGrid_h;
  myReflectorTPBProf_R[myNZR_TPB++] = myAboveGrid_id / 2.;
  myReflectorTPBProf_Z[myNZR_TPB] = myReflector_h + myAboveGrid_h;
  myReflectorTPBProf_R[myNZR_TPB++] = 0;

  G4int myNZR_Ar = 0;
  myReflectorArProf_Z[myNZR_Ar] = myTPBThickness;
  myReflectorArProf_R[myNZR_Ar++] = 0;
  myReflectorArProf_Z[myNZR_Ar] = myTPBThickness;
  myReflectorArProf_R[myNZR_Ar++] = myReflector_id / 2. - myTPBThickness;
  myReflectorArProf_Z[myNZR_Ar] = myReflector_h + myTPBThickness;
  myReflectorArProf_R[myNZR_Ar++] = myReflector_id / 2. - myTPBThickness;
  myReflectorArProf_Z[myNZR_Ar] = myReflector_h + myTPBThickness;
  myReflectorArProf_R[myNZR_Ar++] = myAboveGrid_id / 2. - myTPBThickness;
  myReflectorArProf_Z[myNZR_Ar] = myReflector_h + myAboveGrid_h - myTPBThickness;
  myReflectorArProf_R[myNZR_Ar++] = myAboveGrid_id / 2. - myTPBThickness;
  myReflectorArProf_Z[myNZR_Ar] = myReflector_h + myAboveGrid_h - myTPBThickness;
  myReflectorArProf_R[myNZR_Ar++] = 0;
  ...
  fLogicReflector->SetVisAttributes(new G4VisAttributes(G4Colour(.0, 1.0, .0)));
  ...
  fLogicTPB->SetVisAttributes(new G4VisAttributes(G4Colour(0.0, .50, 1.0)));
  ...
  fLogicActiveLAr->SetVisAttributes(new G4VisAttributes(G4Colour(0.0, 0.0, 1.0)));

  fSolidGasPocket = new G4Tubs("GasPocket_Solid", 0, myAboveGrid_id / 2. - myTPBThickness, myGasGap / 2., 0, myTwoPi);
  if (DSParameters::Get()->GetWithGasPocket()) fLogicGasPocket = new G4LogicalVolume(fSolidGasPocket, DSMaterial::Get()->GetGaseousArgon(), "GasPocket_Logic");
  else
  ...
  // The definition of the active LAr region is needed to set the range cuts for
  ...
  // fLogicGrid  = new G4LogicalVolume( fSolidGrid,
  // DSMaterial::Get()->GetLiquidArgon(), "Grid_Logic" );
  ...
  // G4ThreeVector myBellTopPos = myReflectorPos + G4ThreeVector( 0, 0,
  // myReflectorProf_Z[ myNZR - 1 ] +  myITOThickness + myDivingBellTop_h/2. );
  ...
  // fLogicBellRim->SetVisAttributes(G4VisAttributes::GetInvisible());
  // fLogicBellTop->SetVisAttributes(G4VisAttributes::GetInvisible());
  // fPhysicBellITOTop    = new G4PVPlacement( 0, myBellTopITOTop, "BellITOTop",
  // fLogicITO, fPhysicInnerLiqArgon, false, 0, myCheckOverlap );
  // fPhysicBellITOBottom = new G4PVPlacement( 0, myBellTopITOBottom,
  // "BellITOBottom", fLogicITO, fPhysicInnerLiqArgon, false, 0, myCheckOverlap
  // );

  // Field Rings or simple copper cylinder
  ...
  if (!IsRealisticFieldRings) {
    ...
    // position manually tuned
    int nrings = 15;
    double RingTheigh = 19.05 * mm;  // 19.05
    double RingIheigh = 3.05 * mm;   //
    double RingTthickness = 3.175 * mm;
    double RingIthickness = 9.52 * mm - RingTthickness;
    double RingSpacing = 22.82 * mm;  // 22.22 mm
    double RingSmallOffset = 15.1 * mm;
    // G4Tubs* fSolidGridRing =
    //     new G4Tubs("GridRing_Solid", myReflector_od / 2. - 5 * mm,
    //     myReflector_od / 2., .6 * mm, 0, myTwoPi);
    // G4LogicalVolume* fLogicGridRing =
    //     new G4LogicalVolume(fSolidGridRing,
    //     DSMaterial::Get()->GetStainlessSteel(), "GridRing_Logic");
    G4ThreeVector myGridRingPos = myGasPocketPos - G4ThreeVector(0, 0, 0.7 * cm);
    // new G4PVPlacement( 0, myGridRingPos, "GridRing", fLogicGridRing,
    // fPhysicReflector, false, 0, myCheckOverlap );

    G4Tubs* fSolidFieldRings_o = new G4Tubs("FieldRings_Solid_o", myReflector_od / 2. - RingTthickness, myReflector_od / 2., RingTheigh / 2., 0, myTwoPi);
    G4Tubs* fSolidFieldRings_i = new G4Tubs("FieldRings_Solid_i", myReflector_od / 2. - RingTthickness - RingIthickness, myReflector_od / 2. - RingTthickness, RingIheigh / 2., 0, myTwoPi);
    G4UnionSolid* fSolidFieldRingsU = new G4UnionSolid("FieldRings_SolidU", fSolidFieldRings_o, fSolidFieldRings_i, 0, G4ThreeVector(0, 0, 0));
    fLogicFieldRings = new G4LogicalVolume(fSolidFieldRingsU, DSMaterial::Get()->GetMetalCopper(), "FieldRings_Logic");
    fLogicFieldRings->SetVisAttributes(new G4VisAttributes(G4Colour(1.0, 0.0, 0.0)));
    for (int p = 0; p < nrings; ++p) {
      G4ThreeVector myFieldRingsPos = G4ThreeVector(0, 0, RingSmallOffset + p * RingSpacing);
      new G4PVPlacement(0, myFieldRingsPos, "FieldRings", fLogicFieldRings, fPhysicReflector, false, p, myCheckOverlap);
    }
  }
...
void DSDetectorDS50::DefineSurfaces() {
  ...
  //    G4OpticalSurface *fOpGArLArSurface = new
  //    G4OpticalSurface("OpGArLArSurface"); new
  //    G4LogicalBorderSurface("GArLArSurface", fPhysicGasPocket,
  //    fPhysicActiveLAr, fOpGArLArSurface); fOpGArLArSurface->SetType(
  //    dielectric_dielectric ); fOpGArLArSurface->SetModel( unified );
  //    fOpGArLArSurface->SetFinish( polished );
  //    G4MaterialPropertiesTable *fGArLArSurfProp = new
  ...
  ////////////////////////////////////////
  // TPB <-- LArLayer
  // This surface will carry the diffuse properties of the LArLayer --> TPB
  // single directional surface.
  ////////////////////////////////////////
  G4OpticalSurface* fOpLArLayerTPBSurface = new G4OpticalSurface("OpLArLayerTPBSurface");
  new G4LogicalBorderSurface("LArLayerTPBSurface", fPhysicLArLayer, fPhysicTPB, fOpLArLayerTPBSurface);
  fOpLArLayerTPBSurface->SetType(dielectric_dielectric);
  fOpLArLayerTPBSurface->SetModel(unified);
  fOpLArLayerTPBSurface->SetFinish(ground);
  fOpLArLayerTPBSurface->SetSigmaAlpha(0.3);
  ...
  G4MaterialPropertiesTable* fLArLayerTPBSurfProp = new G4MaterialPropertiesTable();

  fLArLayerTPBSurfProp->AddProperty("SPECULARLOBECONSTANT", pp, specularlobe, NUM);
  fLArLayerTPBSurfProp->AddProperty("SPECULARSPIKECONSTANT", pp, specularspike, NUM);
  fLArLayerTPBSurfProp->AddProperty("BACKSCATTERCONSTANT", pp, backscatter, NUM);
  fLArLayerTPBSurfProp->AddProperty("REFLECTIVITY", pp, reflectivity, NUM);
  fLArLayerTPBSurfProp->AddProperty("TRANSMITTANCE", pp, transmitivity, NUM);

  fLArLayerTPBSurfProp->AddConstProperty("DOLArLayerTPB", 1, true);

  fOpLArLayerTPBSurface->SetMaterialPropertiesTable(fLArLayerTPBSurfProp);
  ...
  if (DSParameters::Get()->GetWithITO()) fITOSurfProp->AddConstProperty("DOITO", 1, true);
  ...
  //////////////////////////// if(DSLogger::GetSeverity() ==
  ///DSLogger::development
  ...
  ////////////////////////////////////////
  // LiquidArgon --> Teflon (fPhysicTeflonCapDiskBottom and
  // fPhysicTeflonCapDiskTop)
  ...
  ////////////////////////////////////////
  // G4OpticalSurface *fOpTPBLArSurface = new
  // G4OpticalSurface("OpTBPLArSurface"); new
  // G4LogicalBorderSurface("TPBLArSurface", fPhysicActiveLAr, fPhysicTPB,
  // fOpTPBLArSurface ); fOpTPBLArSurface->SetType( dielectric_dielectric );
  // fOpTPBLArSurface->SetModel( unified );
  //  fOpTPBLArSurface->SetFinish( ground );
  //  fOpTPBLArSurface->SetSigmaAlpha(0.3);
  //  G4MaterialPropertiesTable *fTPBLArSurfProp = new
  //  G4MaterialPropertiesTable(); fOpTPBLArSurface->SetMaterialPropertiesTable(
  //  fTPBLArSurfProp );
  ...
  ////////////////////////////////////////
  //  BellTop --> Teflon (Reflector)
  //  Should be no Teflon --> BellTop as surface is defined as dielectric_metal.
  ////////////////////////////////////////
  G4double TeflonBTENE[4] = {0.1 * eV, 8.0 * eV, 8.3 * eV, 20.0 * eV};
  G4double TeflonBTREF[4] = {TREFVIS, TREFVIS, TREFUV, TREFUV};

  G4OpticalSurface* fOpBTTeflonSurface = new G4OpticalSurface("OpBTTeflonSurface");
  new G4LogicalBorderSurface("BTTeflonSurface", fPhysicBellTop, fPhysicReflector, fOpBTTeflonSurface);
  new G4LogicalBorderSurface("CWTeflonSurface", fPhysicCathodeWindow, fPhysicReflector, fOpBTTeflonSurface);
  new G4LogicalBorderSurface("FRTeflonSurface", fPhysicCathodeWindow, fPhysicFieldRings, fOpBTTeflonSurface);
  fOpBTTeflonSurface->SetType(dielectric_metal);
  fOpBTTeflonSurface->SetModel(unified);
  // The following settings are giving the desired Lambertian reflection
  fOpBTTeflonSurface->SetFinish(groundfrontpainted);
  fOpBTTeflonSurface->SetSigmaAlpha(0.1);

  G4MaterialPropertiesTable* fBTTeflonSurfProp = new G4MaterialPropertiesTable();
  fBTTeflonSurfProp->AddProperty("REFLECTIVITY", TeflonBTENE, TeflonBTREF, 4);
  fOpBTTeflonSurface->SetMaterialPropertiesTable(fBTTeflonSurfProp);
  ...
  new G4LogicalBorderSurface("DS50OuterSurface", fMotherVolume, fPhysicDS50, fOpElectropolishedStainlessSteelSurface);
  ...
  new G4LogicalBorderSurface("Trunk0Surface", fMotherVolume, fPhysicTrunk0, fOpUntreatedStainlessSteelSurface);

  new G4LogicalBorderSurface("Trunk1Surface", fMotherVolume, fPhysicTrunk1, fOpUntreatedStainlessSteelSurface);

  new G4LogicalBorderSurface("Trunk2Surface", fMotherVolume, fPhysicTrunk2, fOpUntreatedStainlessSteelSurface);

  new G4LogicalBorderSurface("Trunk3Surface", fMotherVolume, fPhysicTrunk3, fOpUntreatedStainlessSteelSurface);

  new G4LogicalBorderSurface("Trunk4Surface", fMotherVolume, fPhysicTrunk4, fOpUntreatedStainlessSteelSurface);

  new G4LogicalBorderSurface("Trunk5Surface", fMotherVolume, fPhysicTrunk5, fOpUntreatedStainlessSteelSurface);

  new G4LogicalBorderSurface("Trunk6Surface", fMotherVolume, fPhysicTrunk6, fOpUntreatedStainlessSteelSurface);

  new G4LogicalBorderSurface("TrunkArSurface", fMotherVolume, fPhysicTrunkAr, fOpUntreatedStainlessSteelSurface);
}

/*
 * $Log: DSDetectorDS50.cc,v $
 * Revision 1.16  2016/03/03 23:09:20  cz2
 * Added fused silica -> Teflon boundary. And modified PAr -> TPB boundary for
 * TPB defects
 *
 * Revision 1.15  2015/10/15 09:24:36  dfranco
 * all units updated: position in cm and energy in keV
 *
 * Revision 1.14  2015/10/06 14:49:40  pagnes
 ...
 * Update model for LAr-TPB and GAr-TPB interface.  Now all Lambertian
 ...
 * Minor adjustments to Fused silica --> TPB optical model and make it
 * bi-directional
 *
 ...
 * Mods to GAr-->TPB optical surface to give more realistic reflection.  Still
 * doesnt execute for TPB-->GAr.
 *
 ...
 * changed optical properties of the materials in order to have consistent array
 * lengths within each material
 *
 * Revision 1.12  2013/05/29 10:50:56  dfranco
 * Restore the correct TPB material
 *
 * Revision 1.11  2013/05/26 03:23:02  swesterd
 * added the data file for veto PMTs and optical boundary properties for the
