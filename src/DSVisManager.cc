...
void DSVisManager::RegisterGraphicsSystems() {
  ...
  ogliqt->SetNickname("OGLI");
  RegisterGraphicsSystem(ogliqt);
  oglsqt->SetNickname("OGL");
  RegisterGraphicsSystem(oglsqt);

#endif

  DSLog(debugging) << "\nYou have successfully chosen to use the following graphics systems." << endlog;
  // PrintAvailableGraphicsSystems ();
}
void DSVisManager::RegisterModelFactories() {
