...
////////////////////////////////////////////////////////////////////////////////
//
DSGeneratorRDMUIcmdWithNucleusAndUnit::DSGeneratorRDMUIcmdWithNucleusAndUnit(const char* theCommandPath, G4UImessenger* theMessenger) : G4UIcommand(theCommandPath, theMessenger) {
...
////////////////////////////////////////////////////////////////////////////////
//
G4String DSGeneratorRDMUIcmdWithNucleusAndUnit::ConvertToString(DSGeneratorRDMNucleus def, const char* unitName) {
  G4double uv = ValueOf(unitName);

  ostringstream os;
  os << def.GetA() << " " << def.GetZ() << " " << def.GetE() / uv << " " << unitName << '\0';
  return G4String(os.str());
}
////////////////////////////////////////////////////////////////////////////////
//
void DSGeneratorRDMUIcmdWithNucleusAndUnit::SetParameterName(const char* theNameA, const char* theNameZ, const char* theNameE, G4bool omittable, G4bool currentAsDefault) {
