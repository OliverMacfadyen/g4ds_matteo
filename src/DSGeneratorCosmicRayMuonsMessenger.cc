...
DSGeneratorCosmicRayMuonsMessenger::DSGeneratorCosmicRayMuonsMessenger(DSGeneratorCosmicRayMuons* fPtclGun) {
  generator = fPtclGun;
  fDirectory = new G4UIdirectory("/ds/generator/cosmicray/");
  fDirectory->SetGuidance("Control of cosmic rays event generator");

  // height of source
  heightCmd = new G4UIcmdWithADoubleAndUnit("/ds/generator/cosmicray/height", this);
  ...
  // radius of source
  radiusCmd = new G4UIcmdWithADoubleAndUnit("/ds/generator/cosmicray/radius", this);
  ...
  depthCmd = new G4UIcmdWithADoubleAndUnit("/ds/generator/cosmicray/depth", this);
  ...
  indexCmd = new G4UIcmdWithADouble("/ds/generator/cosmicray/index", this);
  ...
  energyLowCmd = new G4UIcmdWithADoubleAndUnit("/ds/generator/cosmicray/energyLow", this);
  ...
  energyUpCmd = new G4UIcmdWithADoubleAndUnit("/ds/generator/cosmicray/energyUp", this);
  ...
  fileNameCmd = new G4UIcmdWithAString("/ds/generator/cosmicray/filename", this);
...
void DSGeneratorCosmicRayMuonsMessenger::SetNewValue(G4UIcommand* command, G4String newValues) {
  if (command == heightCmd) {
    ...
    DSLog(trace) << "File of angular spectrum changed to " << generator->GetFileName() << endlog;
