...
///////////////////////////////////////////////////////////////////////////////////
//                                                                               //
//  Original class was modified by D. Franco (APC)                               //
//  Date:   5 September 2023                                                     //
//  Description: We noticed that decay alpha energies are not monochromatics.    //
//               This class applies the relativistic boost as in vacuum, despite //  
//               the decays occur in condensated matter. I added a flag to       //
//               suppress the boost.                                             //
//               Note: in order to replace the original class, both              //
//                     G4RadioactiveDecay.hh and  G4RadioactiveDecayPhysics.hh   //
//                     must be included in g4ds11, although without any          //
//                     modification                                              //
//                                                                               //
///////////////////////////////////////////////////////////////////////////////////
...
void G4RadioactiveDecay::DecayAnalog(const G4Track& theTrack)
{
  ...
  /////////// added by D. Franco //////////
  if (DSStorage::Get()->IsDecayInVacuum()) products->Boost(ParentEnergy, ParentDirection);
  // to replace 
  // products->Boost(ParentEnergy, ParentDirection);
  /////////////////////////////////////////
