...
// Class Description
//
// The G4MGGeneratorRDMUIcmdWithNucleusAndUnit permits input of the nucleus
// definition in terms of its (atomic weight, atomic number, excitation energy).
...
class DSGeneratorRDMUIcmdWithNucleusAndUnit : public G4UIcommand {
 public:  // with description
  DSGeneratorRDMUIcmdWithNucleusAndUnit(const char* theCommandPath, G4UImessenger* theMessenger);
  ...
  void SetParameterName(const char* theNameA, const char* theNameZ, const char* theNameE, G4bool omittable, G4bool currentAsDefault = true);
