#ifndef DSStackingNeutronCapture_h
#define DSStackingNeutronCapture_h 1
#include <vector>
...
class DSStackingNeutronCapture : public DSVStackingAction {
 public:
  DSStackingNeutronCapture();
  virtual ~DSStackingNeutronCapture();
