...
/* January 2017 */
/* -------------------------------------- */
#ifndef DSDetectorDart_H
#define DSDetectorDart_H
...
class DSDetectorDart {

 public:
  DSDetectorDart(G4VPhysicalVolume*);
  ~DSDetectorDart();
 ...
 private:
  ...
  G4Tubs* fSolidLArScint;
  G4LogicalVolume* fLogicLArScint;
  G4VPhysicalVolume* fPhysicLArScint;
