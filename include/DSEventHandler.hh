...
class DSEventHandler {
 ...
 public:
  ...
  void SetNClusters(int val) { theEventStructure.NClusters = val; } // Added to include cluster sizing
  ...
  void SetClusters() { theEventStructure.theClusters.push_back(theClusterStructure); }
  ...
  int GetNClusters() {return theEventStructure.NClusters; } // Added to include cluster sizing 

  std::vector<DaughterStructure>& GetVDaughters() { return theEventStructure.theDaughters; }
  std::vector<PhotoElectronStructure>& GetVPhotoElectrons() { return theEventStructure.thePhotoElectrons; }
  std::vector<PhotoElectronStructure>& GetVMuPhotoElectrons() { return theEventStructure.theMuPhotoElectrons; }
  std::vector<PhotoElectronStructure>& GetVVetoPhotoElectrons() { return theEventStructure.theVetoPhotoElectrons; }
  std::vector<PhotonStructure>& GetVPhotons() { return theEventStructure.thePhotons; }
  std::vector<DepositStructure>& GetVDeposits() { return theEventStructure.theDeposits; }
  std::vector<ClusterStructure>& GetVClusters() { return theEventStructure.theClusters; }
  std::vector<UserStructure>& GetVUsers() { return theEventStructure.theUsers; }
  ...
  void SetClusterRecoilID(float val)      { theClusterStructure.RecoilID = val; }
  //void SetClusterMaterial(int val)   { theClusterStructure.Material = val; }
  void SetClusterS1Energy(float val) { theClusterStructure.S1Energy = val; }
  void SetClusterS2Energy(float val) { theClusterStructure.S2Energy = val; }
  void SetClusterEnergy(float val) { theClusterStructure.Energy = val; }
  void SetClusterTime(double val)  { theClusterStructure.Time = val; }
  void SetClusterPosition(G4ThreeVector);

  float GetClusterRecoilID()      { return theClusterStructure.RecoilID; }
  //int GetClusterMaterial()   { return theClusterStructure.Material; }
  float GetClusterS1Energy() { return theClusterStructure.S1Energy; }
  float GetClusterS2Energy()   { return theClusterStructure.S2Energy; }
  float GetClusterEnergy()   { return theClusterStructure.Energy; }
  double GetClusterTime()  { return theClusterStructure.Time; }
  G4ThreeVector GetClusterPosition() { return CopyArrayToVector(theClusterStructure.Position); }
 ...
 * getvphotoelectrons was returning veto photoelectrons instead of tpc
 * photoelectrons
 *
 * Revision 1.7  2013/08/20 03:25:49  swesterd
 * added G2 TPC geoemtry (not complete) and added monoenergetic energy
 * distribution to generator
 *
