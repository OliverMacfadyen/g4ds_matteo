...
class DSVGeneratorMessenger : public G4UImessenger {
 ...
 private:
  ...
  G4UIcmdWithAnInteger* fGenInLateralESRCmd;
  G4UIcmdWithAnInteger* fGenInLateralTPBCmd;
  G4UIcmdWithAnInteger* fGenInLateralAcrylicCmd;
  G4UIcmdWithAnInteger* fGenInTeflonCmd;
  G4UIcmdWithAnInteger* fGenInGridCmd;
  G4UIcmdWithAnInteger* fGenInGridSupportCmd;
  G4UIcmdWithAnInteger* fGenInSiPMCmd;
  G4UIcmdWithAnInteger* fGenInPDMCmd;
  G4UIcmdWithAnInteger* fGenInSiPMVetoCmd;
  G4UIcmdWithAnInteger* fGenInCopperRingsCmd;
  ...
  G4UIcmdWithAnInteger* fGenInLiquidScintillatorCmd;
  G4UIcmdWithAnInteger* fGenInPlasticScintillatorCmd;
  G4UIcmdWithAnInteger* fGenInTPCBarrelCmd;
  G4UIcmdWithAnInteger* fGenInOPsAcrylicCmd;
  G4UIcmdWithAnInteger* fGenInArgonBufferInsideCmd;
  G4UIcmdWithAnInteger* fGenInArgonBufferOutsideCmd;
  G4UIcmdWithAnInteger* fGenInVetoPMTsCmd;
  G4UIcmdWithAnInteger* fGenInVetoSteelSphereCmd;
  G4UIcmdWithAnInteger* fGenInDS20kSteelStructureCmd;
  G4UIcmdWithAnInteger* fGenIn7mSphereCmd;
  G4UIcmdWithAnInteger* fNumberOfParticlesCmd;
  G4UIcmdWithAnInteger* fGenInDuneCryostatFoamCmd;
  G4UIcmdWithAnInteger* fGenInDuneCryostatMembraneCmd;
  G4UIcmdWithAnInteger* fGenInArDMTestArgonCopperCmd;
  G4UIcmdWithAnInteger* fGenInArDMTestArgonNSCmd;
  G4UIcmdWithAnInteger* fGenInArDMTestArgonAcrylicCmd;
  G4UIcmdWithAnInteger* fGenInArDMTestArgonUndergroundCmd;
  G4UIcmdWithAnInteger* fGenInArDMTestArgonReflectorCmd;
  G4UIcmdWithAnInteger* fGenInArDMTestArgonWLSCmd;

  G4UIcmdWithAnInteger* fGenInArDMDartDetCmd;
  G4UIcmdWithAnInteger* fGenInArDMDartExtCmd;
  G4UIcmdWithAnInteger* fGenInArDMDartSiPMCmd;

  G4UIcmdWithAnInteger* fGenInGantryPipeCmd;
  G4UIcmdWithAnInteger* fGenInTitaniumVesselCmd;
  G4UIcmdWithAnInteger* fAriserSourceHolderCmd;

  G4UIcmdWithAString* fGenInPhysVolumeCmd;
  G4UIcmdWithAnInteger* fGenInAnodeCmd;
  G4UIcmdWithAnInteger* fGenInCathodeCmd;
 ...
 * Revision 1.7  2016/03/08 10:58:14  davini
 * command for uniform distibution in LSV (and DSDetectorNeutronVetoG3 cleanup)
 *
 * Revision 1.6  2015/08/31 09:15:58  pagnes
