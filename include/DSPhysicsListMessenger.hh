...
class DSPhysicsListMessenger : public G4UImessenger {
 ...
 private:
  ...
  G4UIcmdWithABool* fCherenkovCmd;
  G4UIcmdWithABool* fMatScintillationCmd;
};
 ...
 * added S1S2 from NEST and possibility to switch on or off this physics. Work
 * in progress on the physics itsel
 *
