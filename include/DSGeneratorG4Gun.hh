...
class DSGeneratorG4Gun : public DSVGenerator {
 public:
  ...
  // void SetParticlePosition(G4ThreeVector pos){
  // fParticleGun->SetParticlePosition(pos); } void
  // SetParticleDefinition(G4ParticleDefinition* part) {
  // fParticleGun->SetParticleDefinition(part); } void
  // SetParticleMomentumDirection(G4ParticleMomentum mom){
  // fParticleGun->SetParticleMomentumDirection(mom); } void
  // SetParticleEnergy(G4double ene){ fParticleGun->SetParticleEnergy(ene); }
